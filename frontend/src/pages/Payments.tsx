    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Track payments and manage billing</p>
        </div>

        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="glass p-6 rounded-2xl shadow-lg shadow-black/5 card-hover">
            <div className="text-sm text-gray-600 mb-2 font-medium">Total Payments</div>
            <div className="text-3xl font-bold bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent">৳{totalPayments.toFixed(2)}</div>
          </div>
          <div className="glass p-6 rounded-2xl shadow-lg shadow-black/5 card-hover">
            <div className="text-sm text-gray-600 mb-2 font-medium">Total Orders</div>
            <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">{orders.length}</div>
          </div>
          <div className="glass p-6 rounded-2xl shadow-lg shadow-black/5 card-hover">
            <div className="text-sm text-gray-600 mb-2 font-medium">Payment Records</div>
            <div className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent">{payments.length}</div>
          </div>
        </div>
